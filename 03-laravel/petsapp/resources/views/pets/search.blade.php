      ...
      <tr>
        <td>
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              {{-- <div class="text-sm opacity-50"> ID: {{ $pet->$table->foreign('pet_id')->references('id')->on('pets')->onDelete('cascade'); }}</div> --}}
            </div>
          </div>
        </td>
        <td>
        ...
        <td class="md:table-cell hidden">{{ $pet->age }}</td>
        <td class="md:table-cell hidden">{{ $pet->breed }}</td>
        <td class="md:table-cell hidden">{{ $pet->weight }}</td>
        <td class="md:table-cell hidden">{{ $pet->location }}</td>
