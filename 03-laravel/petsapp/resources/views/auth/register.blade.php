...
@section('content')
    ...
    <form method="post" action="{{ route('register') }}" class="pt-30 pb-20">
        ...
        <fieldset class="fieldset w-md bg-base-200 border border-base-300 p-4 rounded-box">
                ...
                <input type="phone" name="phone" class="input rounded-full" placeholder="3210000001" value="{{old('phone')}}/>
                
                <label class="fieldset-label">Email</label>
                <input type="email" name="email" class="input rounded-full w-full" placeholder="Email" value="{{old('email')}}/>
